...
module {
    ...
    public type StableStore = V0_2_1_types.StableStore;
    ...
    public func get_current_state(asset_versions : VersionedStableStore) : V0_2_1_types.StableStore {
        switch (asset_versions) {
            case (#v0_2_1(stable_store)) { stable_store };
            case (_) Debug.trap(
                "
    ...
    public func share_version(sstore : V0_2_1_types.StableStore) : VersionedStableStore {
        #v0_2_1(sstore);
    };
