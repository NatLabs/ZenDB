...
module {
    ...
    public func get_leaf_address_and_update_path<K, V>(btree : MemoryIdBTree, btree_utils : BTreeUtils<K, V>, key : K, _opt_key_blob : ?Blob, update : (MemoryIdBTree, Nat, Nat) -> ()) : Nat {
        var curr_address = btree.root;
        var opt_key_blob : ?Blob = _opt_key_blob;
