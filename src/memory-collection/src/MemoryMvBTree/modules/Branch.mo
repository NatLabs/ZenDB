...
module Branch {
    ...
    type MemoryMvBTree = Migrations.MemoryMvBTree;
    ...
    public func get_memory_size(btree : MemoryMvBTree) : Nat {
    ...
    public func CHILDREN_START(btree : MemoryMvBTree) : Nat {
    ...
    public func get_child_offset(btree : MemoryMvBTree, branch_address : Nat, i : Nat) : Nat {
        branch_address + CHILDREN_START(btree) + (i * MC.ADDRESS_SIZE);
    };

    public func new(btree : MemoryMvBTree) : Nat {
    ...
    public func from_memory(btree : MemoryMvBTree, branch_address : Address) : Branch {
    ...
    func from_memory_into(btree : MemoryMvBTree, address : Address, branch : Branch, load_keys : Bool) {
    ...
    func calc_heuristic(btree : MemoryMvBTree) : Float {
    ...
    public func add_to_cache(btree : MemoryMvBTree, address : Nat) {
    ...
    public func rm_from_cache(btree : MemoryMvBTree, address : Address) {
        if (LruCache.capacity(btree.nodes_cache) == 0) return;
        ignore LruCache.remove(btree.nodes_cache, nhash, address);
    };

    public func display(btree : MemoryMvBTree, btree_utils : BTreeUtils<Nat, Nat>, branch_address : Nat) {
    ...
    public func update_index(btree : MemoryMvBTree, branch_address : Nat, new_index : Nat) {
    ...
    public func put_key_id(btree : MemoryMvBTree, branch_address : Nat, i : Nat, key_id: UniqueId) {
    ...
    public func put_child(btree : MemoryMvBTree, branch_address : Nat, i : Nat, child_address : Nat) {
    ...
    public func get_node_subtree_size(btree : MemoryMvBTree, node_address : Address) : Nat {
    ...
    public func add_child(btree : MemoryMvBTree, branch_address : Nat, child_address : Nat) {
    ...
    public func get_node_type(btree : MemoryMvBTree, node_address : Nat) : NodeType {
    ...
    public func get_count(btree : MemoryMvBTree, branch_address : Nat) : Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func get_index(btree : MemoryMvBTree, branch_address : Nat) : Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func get_parent(btree : MemoryMvBTree, branch_address : Nat) : ?Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func get_key_id(btree : MemoryMvBTree, branch_address : Nat, i : Nat) : ?UniqueId {
        let key_offset = get_key_id_offset(branch_address, i);
    ...
    public func get_key_blob(btree : MemoryMvBTree, branch_address : Nat, i : Nat) : ?(Blob) {

        let ?id = Branch.get_key_id(btree, branch_address, i) else return null;
        ?MemoryBlock.get_key_blob(btree, id);
    };

    public func set_key_id_to_null(btree : MemoryMvBTree, branch_address : Nat, i : Nat) {

        let key_offset = get_key_id_offset(branch_address, i);
        MemoryRegion.storeNat64(btree.metadata, key_offset, MC.NULL_ADDRESS);
    };

    public func get_child(btree : MemoryMvBTree, branch_address : Nat, i : Nat) : ?Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func set_child_to_null(btree : MemoryMvBTree, branch_address : Nat, i : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func get_subtree_size(btree : MemoryMvBTree, branch_address : Nat) : Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func binary_search<K, V>(btree : MemoryMvBTree, btree_utils : BTreeUtils<K, V>, address : Nat, cmp : (K, K) -> Int8, search_key : K, arr_len : Nat) : Int {
    ...
    public func binary_search_blob_seq(btree : MemoryMvBTree, address : Nat, cmp : (Blob, Blob) -> Int8, search_key : Blob, arr_len : Nat) : Int {
        if (arr_len == 0) return -1; // should insert at index Int.abs(i + 1)
        var l = 0;
    ...
    public func update_count(btree : MemoryMvBTree, branch_address : Nat, count : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func update_subtree_size(btree : MemoryMvBTree, branch_address : Nat, new_size : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func update_parent(btree : MemoryMvBTree, branch_address : Nat, opt_parent : ?Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, branch_address)) {
    ...
    public func update_median_key_id(btree : MemoryMvBTree, parent_address : Nat, child_index : Nat, new_key_id : UniqueId) {
    ...
    public func insert(btree : MemoryMvBTree, branch_address : Nat, i : Nat, key_id: UniqueId, child_address : Nat) {
        let count = Branch.get_count(btree, branch_address);
    ...
    public func split(btree : MemoryMvBTree, branch_address : Nat, child_index : Nat, child_key_id : UniqueId, child : Nat) : Nat {
    ...
    public func get_larger_neighbour(btree : MemoryMvBTree, parent_address : Address, index : Nat) : ?Address {
    ...
    public func shift(btree : MemoryMvBTree, branch : Address, start : Nat, end : Nat, offset : Int) {
    ...
    public func remove(btree : MemoryMvBTree, branch : Address, index : Nat) {
    ...
    public func redistribute(btree : MemoryMvBTree, branch : Address) : Bool {
    ...
    public func deallocate(btree : MemoryMvBTree, branch : Address) {
        let memory_size = Branch.get_memory_size(btree);
        MemoryRegion.deallocate(btree.metadata, branch, memory_size);
    };

    public func merge(btree : MemoryMvBTree, branch : Address, neighbour : Address) : (deallocated_branch : Address) {
