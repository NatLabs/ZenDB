...
module Leaf {
    ...
    public func validate(btree : MemoryMvBTree, address : Nat) : Bool {
    ...
    public func from_memory(btree : MemoryMvBTree, address : Nat) : Leaf {
    ...
    public func from_memory_into(btree : MemoryMvBTree, address : Nat, leaf : Leaf, load_keys : Bool) {
    ...
    public func display(btree : MemoryMvBTree, btree_utils : BTreeUtils<Nat, Nat>, leaf_address : Nat) {
    ...
    public func get_count(btree : MemoryMvBTree, address : Nat) : Nat {
    ...
    public func get_kv_id(btree : MemoryMvBTree, address : Nat, i : Nat) : ?UniqueId {
    ...
    public func get_key_block(btree : MemoryMvBTree, address : Nat, i : Nat) : ?MemoryBlock {
        let ?id = get_kv_id(btree, address, i);
        ?MemoryBlock.get_key_block(btree, id);
    };

    public func get_val_block(btree : MemoryMvBTree, address : Nat, i : Nat) : ?MemoryBlock {
        let ?id = get_kv_id(btree, address, i);
        ?MemoryBlock.get_val_block(btree, id);
    };

    public func get_key_blob(btree : MemoryMvBTree, address : Nat, i : Nat) : ?(Blob) {
        let ?id = get_kv_id(btree, address, i);
        ?MemoryBlock.get_key_blob(btree, id);
    };

    public func set_key_to_null(btree : MemoryMvBTree, address : Nat, i : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
            case (? #leaf(leaf)) {
                leaf.2 [i] := null;
                leaf.4 [i] := null;
    ...
    public func get_val_blob(btree : MemoryMvBTree, address : Nat, index : Nat) : ?(Blob) {

        let ?id = get_kv_id(btree, address, index);
        ?MemoryBlock.get_val_blob(btree, id);
    };

    public func get_val_blobs(btree : MemoryMvBTree, address : Nat, index : Nat) : Iter<Blob> {
        let ?id = get_kv_id(btree, address, index) else return Itertools.empty();
        MemoryBlock.get_val_blobs(btree, id);
    };

    public func set_kv_to_null(btree : MemoryMvBTree, address : Nat, i : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
            case (? #leaf(leaf)) {
                leaf.2 [i] := null;
                leaf.3 [i] := null;
    ...
    public func get_kv_blobs(btree : MemoryMvBTree, address : Nat, index : Nat) : ?(Blob, Blob) {
    ...
    public func get_parent(btree : MemoryMvBTree, address : Nat) : ?Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func get_index(btree : MemoryMvBTree, address : Nat) : Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func get_next(btree : MemoryMvBTree, address : Nat) : ?Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func get_prev(btree : MemoryMvBTree, address : Nat) : ?Nat {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func update_count(btree : MemoryMvBTree, address : Nat, new_count : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func update_index(btree : MemoryMvBTree, address : Nat, new_index : Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func update_parent(btree : MemoryMvBTree, address : Nat, opt_parent : ?Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func update_next(btree : MemoryMvBTree, address : Nat, opt_next : ?Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func update_prev(btree : MemoryMvBTree, address : Nat, opt_prev : ?Nat) {
        switch (LruCache.peek(btree.nodes_cache, nhash, address)) {
    ...
    public func clear(btree : MemoryMvBTree, leaf_address : Nat) {
    ...
    public func insert(btree : MemoryMvBTree, leaf_address : Nat, index : Nat, new_id: UniqueId) {
    ...
    public func insert_with_count(btree : MemoryMvBTree, leaf_address : Nat, index : Nat, new_id: UniqueId, count: Nat) {
        assert index <= count and count < btree.order;
    ...
    public func put(btree : MemoryMvBTree, leaf_address : Nat, index : Nat, new_id: UniqueId) {

        let id_offset = get_kv_id_offset(leaf_address, index);
        MemoryRegion.storeNat64(btree.metadata, id_offset, Nat64.fromNat(new_id));
    };

    public func split(btree : MemoryMvBTree, leaf_address : Nat, elem_index : Nat, new_id: UniqueId) : Nat {
    ...
    public func shift(btree : MemoryMvBTree, leaf_address : Nat, start : Nat, end : Nat, offset : Int) {
        if (offset == 0) return;
    ...
    public func remove(btree : MemoryMvBTree, leaf_address : Nat, index : Nat) {
        let count = Leaf.get_count(btree, leaf_address);
    ...
    public func redistribute(btree : MemoryMvBTree, leaf : Nat, neighbour : Nat) : Bool {
    ...
    public func deallocate(btree : MemoryMvBTree, leaf : Nat) {
        let memory_size = Leaf.get_memory_size(btree);
        MemoryRegion.deallocate(btree.metadata, leaf, memory_size);
    };

    public func merge(btree : MemoryMvBTree, leaf : Nat, neighbour : Nat) {
        let leaf_index = Leaf.get_index(btree, leaf);
        let neighbour_index = Leaf.get_index(btree, neighbour);
