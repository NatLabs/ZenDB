    ...
    public func from_and_operation(
        ...
        let best_index_result = switch (Index.get_best_index(collection, Buffer.toArray(operations), sort_column)) {
            case (null) {
                ...
                let (scan_bounds, filter_bounds) = Index.convert_simple_ops_to_bounds(true, Buffer.toArray(simple_operations), null, null);
        ...
        Logger.lazyDebug(
            collection.logger,
            func() = "QueryPlan.from_and_operation(): Index details - " #
        ...
        Logger.lazyDebug(
            collection.logger,
            func() {
                "QueryPlan.from_or_operation(): Index scan intervals: " # debug_show interval;
            },
        );
                ...
                case (#Operation(field, op)) {
                    ...
                    let scan_details = switch (opt_index) {
                        ...
                        case (?best_index_info) {
                            ...
                            Logger.lazyDebug(
                                collection.logger,
                                func() = "QueryPlan.from_or_operation(): Index details - " #
                                "requires_additional_filtering: " # debug_show requires_additional_filtering # ", " #
                                "requires_additional_sorting: " # debug_show requires_additional_sorting # ", " #
                                "sorted_in_reverse: " # debug_show sorted_in_reverse,
                            );
