...
import { sort_candid_type } "mo:serde@3.3.2/Candid/Blob/CandidUtils";
...
module {
    ...
    public func validate_schema(schema : Schema) : T.Result<(), Text> {
        switch (schema) {
    ...
    public func validate(schema : Schema, document : Candid) : T.Result<(), Text> {
    ...
    public func generate_default_value(schema : Schema) : T.Result<Candid, Text> {
