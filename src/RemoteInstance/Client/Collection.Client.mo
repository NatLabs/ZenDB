...
module {
    ...
    public class CollectionClient<Record>(
        ...
        public func search(stable_query : ZT.StableQuery) : async* (ZT.Result<[(ZT.DocumentId, Blob)], Text>) {
        ...
        public func delete(db_query : ZT.StableQuery) : async* (ZT.Result<[(ZT.DocumentId, Blob)], Text>) {
