...
let schema : ZenDB.Schema = #Record([
    ...
    (
        ...
        #Record([
            ...
            (
                "settings",
                #Record([("theme", #Text), ("notifications", #Bool)]),
            ),
        ]),
    ),
    (
    ...
    func() {
        ...
        test(
            ...
            func() {
                ...
                assert candid_map.get("details.settings.theme") == ?#Text("light");

                let #ok(_) = candid_map.set("details.settings.notifications", #Bool(false));
                assert candid_map.get("details.settings.notifications") == ?#Bool(false);
        ...
        test(
            ...
            func() {
                ...
                let #ok(_) = candid_map.set("details", #Record([("phone", #Text("2893749823")), ("address", #Text("789, 7th Cross, 8th Main, Bangalore")), ("settings", #Record([("theme", #Text("dark")), ("notifications", #Bool(true))]))]));
        ...
        test(
            ...
            func() {
                ...
                assert extracted_candid == #Record([
                    ...
                    ("details", #Record([("phone", #Text("2893749823")), ("address", #Text("789, 7th Cross, 8th Main, Bangalore")), ("settings", #Record([("theme", #Text("dark")), ("notifications", #Bool(true))]))])),
                    (
                        "version",
