...
let candid_map = CandidMap.new(candid);

Debug.print("schema_map: " # debug_show Map.toArray(schema_map));
    ...
    func() {
        ...
        test(
            ...
            func() {
                ...
                Debug.print("version.v1: " # debug_show CandidMap.get(candid_map, schema_map, "version.v1"));
                Debug.print("candid_map: " # debug_show Map.toArray(candid_map));
        ...
        test(
            ...
            func() {
                ...
                let #ok(_) = CandidMap.set(candid_map, schema_map, "details.settings.notifications", #Bool(true));
                assert CandidMap.get(candid_map, schema_map, "details.settings.notifications") == ?#Bool(true);
